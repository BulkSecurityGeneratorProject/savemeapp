...
describe('Service Tests', () => {
    ...
    describe('HoSoCn Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(HoSoCnService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/ho-so-cns';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return HoSoCn', () => {

                let entity: HoSoCn;
                service.find(123).subscribe((_entity: HoSoCn) => {
                    entity = _entity;
                });
