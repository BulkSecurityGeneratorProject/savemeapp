...
import com.myapp.silk.config.audit.AuditEventConverter;
import com.myapp.silk.domain.PersistentAuditEvent;
...
import static com.myapp.silk.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
